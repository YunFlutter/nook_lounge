...
class MarketTabPage extends ConsumerStatefulWidget {
  ...
  static Future<void> openMyTradesPage(
    BuildContext context,
    WidgetRef ref,
  ) async {
    ref.read(marketViewModelProvider.notifier).ensureProposalTracking();
    await Navigator.of(context).push(
      AppPageRoute<void>(
        screenName: AppScreenNames.marketMyTrades,
        builder: (_) => const MarketMyTradesPage(),
      ),
    );
  }
}
...
class _MarketTabPageState extends ConsumerState<MarketTabPage> {
  ...
  Widget build(BuildContext context) {
    ...
    return AppScreenView(
      screenName: AppScreenNames.marketTab,
      child: Stack(
        children: <Widget>[
          RefreshIndicator(
            onRefresh: () async {
  ...
  Future<void> _openTradeRegisterPage(BuildContext context) async {
    await Navigator.of(context).push(
      AppPageRoute<void>(
        ...
        builder: (_) => const MarketTradeRegisterPage(),
      ),
    );
  }
